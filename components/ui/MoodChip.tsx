...
export default function MoodChip({
  ...
  return (
    <button
      ...
      className={`rounded-full border px-3 py-2.5 text-sm font-medium transition-all duration-200 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400/40 active:scale-[0.97] ${
        selected
